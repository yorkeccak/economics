...
export const metadata: Metadata = {
  ...
  title: {
    default: "Economics by Valyu",
    template: "%s | Economics by Valyu",
  },
  description:
  ...
  applicationName: "Economics by Valyu",
  openGraph: {
    title: "Economics by Valyu",
    description:
      "AI-powered analysis by Valyu. Real-time data, secure Python execution in Daytona sandboxes, and interactive visualizations for research and reporting.",
    url: "/",
    siteName: "Economics by Valyu",
    images: [
      {
        url: "/valyu.png",
        width: 1200,
        height: 630,
        alt: "Economics by Valyu",
      },
    ],
    locale: "en_US",
    type: "website",
