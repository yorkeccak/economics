...
export function OllamaStatusIndicator({
  ...
  const getModelRecommendation = (modelName: string) => {
    ...
    if (
      name.includes("qwen") &&
      (name.includes("7b") || name.includes("14b") || name.includes("32b"))
    ) {
      return { type: "recommended", text: "Excellent for tool calling" };
    }
    if (
      name.includes("llama") &&
      (name.includes("7b") || name.includes("13b") || name.includes("70b"))
    ) {
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="space-y-3 text-xs text-gray-600 dark:text-gray-400">
                    ...
                    <div className="space-y-2 ml-2">
                      <div>
                        1. Install Ollama and pull a model (qwen2.5:7b
                        recommended)
                      </div>
                      <div>
                        2. Click the Local Models button to select your model
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start gap-3 p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg">
                        ...
                        <div className="text-xs text-amber-800 dark:text-amber-200">
                          ...
                          Many models struggle with function calling. We
                          recommend <strong>Qwen2.5:7B or larger</strong> for
                          best results with financial tools.
                        </div>
                      </div>
